...
class ClientUsersControllerTest < ActionController::TestCase
  ...
  test "should create client_user" do
    assert_difference('ClientUser.count') do
      post :create, client_user: { address: @client_user.address, birthday: @client_user.birthday, gender: @client_user.gender, phone: @client_user.phone, zipcode: @client_user.zipcode }
    end
  ...
  test "should update client_user" do
    put :update, id: @client_user, client_user: { address: @client_user.address, birthday: @client_user.birthday, gender: @client_user.gender, phone: @client_user.phone, zipcode: @client_user.zipcode }
    assert_redirected_to client_user_path(assigns(:client_user))
  end
